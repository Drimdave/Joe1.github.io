...
recognition.onresult = function(event) {
    ...
    if(command.includes("how are you")){
        ...
        speak("I am a virtual assistant ready to help you with your everyday tasks");
    }
    else if(command.includes("who made you")){
        speak("I was created by Master David right in his laptop");
    }
        ...
        fetch("https://api.openweathermap.org/data/2.5/weather?q=Lagos&appid=f27b38318f3cd72d6c4a4e0c61cd1e37")
        .then(response => response.json())
        .then(data => {
            console.log(data)
        ...
        function success(position){
            ...
            fetch("https://api.mapbox.com/geocoding/v5/mapbox.places/" + lon + "," + lat + ".json?proximity=-74.70850,40.78375&access_token=pk.eyJ1IjoiZHJpbWRhdmUiLCJhIjoiY2wzYmpobGh3MDQxdjNicDFjc3A3Z2ZndiJ9.Xn_B_cse1TnX2k9rMPTEyw")
            .then(response => response.json())
            .then(data => {
        ...
        fetch("https://api.mapbox.com/geocoding/v5/mapbox.places/"+ query + ".json?proximity=-74.70850,40.78375&access_token=pk.eyJ1IjoiZHJpbWRhdmUiLCJhIjoiY2wzYmpobGh3MDQxdjNicDFjc3A3Z2ZndiJ9.Xn_B_cse1TnX2k9rMPTEyw")
        .then(response => response.json())
        .then(data => {
